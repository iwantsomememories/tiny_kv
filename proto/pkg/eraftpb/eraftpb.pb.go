...
const (
	...
	// 'MessageType_MsgCheckQuorum' is a local message used for checking quorum.
	MessageType_MsgCheckQuorum MessageType = 13
	// 'MsgUnreachable' is used to report that the node is currently unreachable.
	MessageType_MsgUnreachable MessageType = 14
	// 'MsgSnapStatus' is used to report that the current snapshot receiving status of a node.
	MessageType_MsgSnapStatus MessageType = 15
)
...
var fileDescriptor_acd9f78e51523dd8 = []byte{
	...
	,
}
